...
console.log('task 1b:', createMenuItem('crepes', 5, 'Dessert'))
console.log('task 1b:', createMenuItem('sushi', 7, 'Lunch'))
...
function addReview(){
  reviews.push('Liz, 5, Super yummy food!')
}
...
function getReviewByIndex(array, number){
  return `${array[number].name} gave the restuarant a ${array[number].rating} star review, and their feedback was: ${array[number].feedback}`;
}
